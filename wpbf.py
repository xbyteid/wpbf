...
if len(sys.argv) <= 1:
    print 'WP-crack v1.0 (c)2019 by Wannabe_ID - a very fast logon WordPress Cracker'
    print 'Website: http://www.destroysquad.com'
    print 'Mail   : wannabeid7@gmail.com'
    print ''
...
print 'WP-crack 1.0 (c)2019 by Wannabe_ID - a very fast logon WordPress Cracker'
print 'Website: http://www.destroysquad.com'
print 'Mail   : wannabeid7@gmail.com'
